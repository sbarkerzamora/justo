...
export default async function ToolDetailPageEn({
  params,
  searchParams,
}: {
  params: Promise<{ slug: string }>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
              <span className="rounded-full border border-border px-2.5 py-0.5 font-medium">
                {cc
                  ...
                  : `${tool.countrySupport.length} countries`}
              </span>
        ...
        <section className="mx-auto w-full max-w-2xl px-6 pb-24">
          <div className="rounded-xl border border-border/40 px-6 py-5">
            <p className="text-xs leading-relaxed text-muted-foreground">
              {tool.disclaimer} If there is a dispute, incomplete data or a
              complex situation, verify the result with professional legal or
              accounting review.
            </p>
          </div>
        </section>
