...
export async function generateMetadata({
  ...
  const title = `Calculadora de vacaciones${namePart} | Justo`

  return getToolPageMetadata({ slug: "vacaciones", tool, country: cc, title })
}
        ...
        <section className="mx-auto w-full max-w-2xl px-6 py-20 sm:py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              ...
              href={
                cc
                  ? `/docs/legal/${cc.toLowerCase()}/vacaciones`
                  : "/docs/legal"
              }
            >
              Ver corpus legal
        ...
        <section className="mx-auto w-full max-w-2xl px-6 pb-24">
          <div className="rounded-xl border border-border/40 px-6 py-5">
            <p className="text-xs leading-relaxed text-muted-foreground">
              {tool.disclaimer} Si el salario fue variable, hubo pagos
              parciales, conflicto o datos incompletos, valida el resultado con
              revisión legal o contable profesional.
            </p>
          </div>
        </section>
      </main>
