...
export const metadata: Metadata = {
  ...
  description:
    "Calcula vacaciones acumuladas, gozadas, pendientes y monto estimado en Nicaragua con formula deterministica y corpus abierto.",
}
      ...
      <section className="mx-auto w-full max-w-2xl px-6 pb-24">
        <div className="rounded-xl border border-border/40 px-6 py-5">
          <p className="text-xs leading-relaxed text-muted-foreground">
            ...
            o datos incompletos, valida el resultado con revision legal o contable profesional.
          </p>
        </div>
      </section>
    </main>
