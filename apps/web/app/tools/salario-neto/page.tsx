...
export async function generateMetadata({
  ...
  const title = `Calculadora de salario neto${namePart} | Justo`

  return getToolPageMetadata({ slug: "salario-neto", tool, country: cc, title })
}
        ...
        <section className="mx-auto w-full max-w-2xl px-6 pb-24">
          <div className="rounded-xl border border-border/40 px-6 py-5">
            <p className="text-xs leading-relaxed text-muted-foreground">
              {tool.disclaimer} Si el salario fue variable, hubo pagos parciales
              o ingresos no salariales, valida el resultado con revisión legal o
