...
export const getCostaRicaTerminationParams = (): TerminationParams => ({
  currency: "CRC",
  ...
  scenarios: [
    {
      ...
      applicable: true,
      buildLines: () => [],
      note: "La renuncia voluntaria no genera auxilio de cesantía (Art. 29).",
    },
    {
      type: "despido_justificado",
      applicable: false,
      note: "No aplica auxilio de cesantía (Art. 29: despido injustificado o causa ajena al trabajador).",
    },
    {
    ...
    },
    {
      ...
      applicable: true,
      buildLines: () => [],
      note: "El mutuo acuerdo no genera auxilio de cesantía (Art. 29).",
    },
  ],
})
