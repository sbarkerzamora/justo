...
export const calculateNicaraguaPreaviso = (input: PreavisoInput): PreavisoResult => {
  ...
  return {
    ...
    calculationNote: "Preaviso segun antiguedad. <6 meses: 7 dias. 6-12 meses: 14 dias. 1-5 anos: 30 dias. >5 anos: 60 dias.",
