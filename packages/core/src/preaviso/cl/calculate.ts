...
export const calculateChilePreaviso = (input: PreavisoInput): PreavisoResult => {
  ...
  return {
    ...
    calculationNote: "Indemnizacion sustitutiva del aviso previo. 30 dias (1 mes) independiente de la antiguedad.",
