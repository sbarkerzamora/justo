...
export const calculateElSalvadorPreaviso = (
  input: PreavisoInput
): PreavisoResult => {
  ...
  return applyPreavisoInputAdjustments(input, {
    ...
    calculationNote:
      "El Salvador no exige preaviso patronal. La indemnizacion por despido injustificado es de 30 dias por ano (Art. 58 CT).",
