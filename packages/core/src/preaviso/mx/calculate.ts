...
export const calculateMexicoPreaviso = (input: PreavisoInput): PreavisoResult => {
  ...
  return {
    ...
    calculationNote: "Mexico no contempla preaviso patronal. El despido injustificado genera indemnizacion constitucional de 90 dias (Art. 48 LFT).",
