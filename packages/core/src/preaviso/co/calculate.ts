...
export const calculateColombiaPreaviso = (input: PreavisoInput): PreavisoResult => {
  ...
  return {
    ...
    calculationNote: "Colombia no exige preaviso patronal para contratos a termino indefinido. La indemnizacion por despido injustificado se calcula segun Art. 64 CST.",
