...
- Ley 19.728, Seguro de Cesantia.
- Cotizacion trabajador: 0.6%.
- Cotizacion empleador: 2.4%.

## formula

- `afc_laboral = base_afc * 0.006`

## supuestos

- `tasa_afc = 0.006` (0.6% trabajador).
...
- Fuente declarada del resumen: Ley 19.728 (Seguro de Cesantia).
...
- "¿Cómo aplica afc en mi liquidación?"
- "¿Qué datos necesito para revisar afc?"
