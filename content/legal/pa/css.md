...
- `tasa_css_laboral = 0.0975` (9.75%, pendiente confirmacion legal final en produccion).

## vigencia_fuente

- Se requiere validacion periodica por cambios normativos de la CSS.
...
- Fuente declarada del resumen: Ley Organica de la Caja de Seguro Social.
...
- "¿Cómo aplica css en mi liquidación?"
- "¿Qué datos necesito para revisar css?"
